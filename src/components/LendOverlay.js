...
export default function LendOverlay({lendRequestValues: {device, datepickerValue}, onCancel, onSubmit}) {
    return (
        <>
            <div className="lend-overlay">
                <div className="lend-overlay__window">
                    ...
                    <div className="lend-overlay__grid">
                        ...
                        <p className="lend-overlay__info-item">{datepickerValue.from.toLocaleDateString()}</p>
                        <p className="lend-overlay__info-label">To</p>
                        <p className="lend-overlay__info-item">{datepickerValue.to.toLocaleDateString()}</p>
                    </div>
                    <div className="lend-overlay__grid">
